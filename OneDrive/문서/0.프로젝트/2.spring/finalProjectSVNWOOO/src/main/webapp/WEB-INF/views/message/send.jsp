		...
		<form role="form" action="/message/messageRegister" method="post">
			...
			<div class="board_header">
				<div class="board_title">
					...
					<p>
						<!--  <label class="sendM">받는 사람</label><input type="text" name="m_eid1"value="" /> -->
						<%-- <select name="m_eid1">
                    	...
                    	<label class="sendM">받는 사람</label>
							...
							<label class="sendM">보내는 사람</label> <input
							type="text" class="" name="m_eid2"
			...
			<div class="brd_btn_control right">
				...
				<button type="button" class="btn_sz_md btn_bg3"
					onclick="location.href='/message/messageList?m_eid1=<sec:authentication property='principal.member.e_name'/>'">목록</button>
